...
struct SparseVoxelGpuStats {
    ...
    uint32_t renderOwnerFarTerrainCallsLastRetire = 0;
    uint32_t renderOwnerFarTerrainEarlyRejectsLastRetire = 0;
    uint32_t renderOwnerFarTerrainFirstSampleHitsLastRetire = 0;
    uint32_t renderOwnerFarTerrainLoopHitsLastRetire = 0;
    uint32_t renderOwnerFarTerrainMissesLastRetire = 0;
    uint32_t renderOwnerFarTerrainSkyBreaksLastRetire = 0;
    uint32_t renderOwnerFarTerrainStepsLastRetire = 0;
    uint32_t renderOwnerFarTerrainRefineStepsLastRetire = 0;
    uint32_t renderOwnerFarTerrainHeightEvalsLastRetire = 0;
    uint32_t renderOwnerFarTerrainSkyBreakStepsLastRetire = 0;
    uint32_t renderOwnerFarTerrainSkyBreakHeightEvalsLastRetire = 0;
    uint32_t renderOwnerFarTerrainDeepMissStepsLastRetire = 0;
    uint32_t renderOwnerFarTerrainDeepMissHeightEvalsLastRetire = 0;
    uint32_t renderOwnerFarTerrainHitStepsLastRetire = 0;
    uint32_t renderOwnerFarTerrainHitHeightEvalsLastRetire = 0;
    uint32_t renderOwnerFarTerrainHitRefineStepsLastRetire = 0;
    uint32_t renderOwnerFarTerrainFirstHitHeightEvalsLastRetire = 0;
    uint32_t renderOwnerFarTerrainLoopHitHeightEvalsLastRetire = 0;
    uint32_t renderOwnerFarTerrainCacheRejectsLastRetire = 0;
    uint32_t renderOwnerHorizonTileMaskTilesLastRetire = 0;
    uint32_t renderOwnerHorizonTileMaskTotalTilesLastRetire = 0;
    uint32_t renderOwnerHorizonTileMaskPixelUpperLastRetire = 0;
    uint32_t renderOwnerHorizonTileMaskMaxEdge255LastRetire = 0;
    uint32_t renderOwnerHorizonTileMaskFrameLastRetire = 0;
    uint32_t renderOwnerHorizonTileMaskBandTilesLastRetire = 0;
    uint32_t renderOwnerHorizonTileListCountLastRetire = 0;
    uint32_t renderOwnerHorizonTileDrawInstancesLastRetire = 0;
